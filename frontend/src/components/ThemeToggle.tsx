...
function MoonIcon() {
    return (
        <svg width="10" height="10" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
    ...
    return (
        ...
        >
            ...
            <span className="theme-toggle-control">
                <span className={`theme-toggle-flank${!isLight ? ' theme-toggle-flank-active' : ''}`} aria-hidden="true">
                    <MoonIcon />
                </span>
